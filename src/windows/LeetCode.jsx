    ...
    <div className="flex flex-col gap-0.5 min-w-0">
      <div className="flex items-center justify-between gap-2">
        ...
        <span className="text-[10px] font-semibold text-[#1a1a1a]">
          {solved}
          <span className="text-[9px] text-[#6c6c6c]">/{totalSolved}</span>
        </span>
      </div>
...
const LeetCode = () => {
  ...
  const loadStats = async (isRefresh = false) => {
    ...
    setError(null);
    try {
      // Force bypass cache on manual refresh
      if (isRefresh) {
        clearLeetCodeCache("Atrish07");
      }
      const data = await fetchLeetCodeStats("Atrish07");
      console.log("Loaded LeetCode data:", data);
      setStats(data);
  ...
  const submissionCount = React.useMemo(() => {
    ...
    return Object.values(calendarObj).reduce(
  ...
  return (
    <>
      ...
      <div
        className="flex flex-col flex-1 min-h-0 bg-white text-[#1a1a1a] overflow-hidden rounded-b-xl"
        style={{
        ...
        <div className="flex-1 min-h-0 flex flex-col overflow-hidden p-4 w-full bg-[#fafafa]">
          ...
          {error && !loading && (
            <div className="flex flex-col items-center justify-center flex-1 gap-4">
              ...
              <p className="text-[#ef4743] font-medium text-center px-4 text-sm">
          ...
          {stats && !loading && (
            <>
              ...
              <div className="flex gap-2 flex-shrink-0 flex-wrap items-stretch mb-2">
                ...
                <div className="bg-white rounded-lg shadow-sm border border-[#e5e5e5] p-2 shrink-0 w-[180px]">
                  <div className="flex flex-col items-center">
                    ...
                    <div className="text-center mb-1">
                      ...
                      <p className="text-[#6c6c6c] text-[10px] font-medium">
                        {username}
                      </p>
                      <p className="text-[#6c6c6c] text-[9px]">
                ...
                <div className="bg-white rounded-lg shadow-sm border border-[#e5e5e5] p-2 flex-1 min-w-0 flex flex-col gap-2 max-w-[280px]">
                  <h2 className="text-sm font-semibold text-[#1a1a1a] text-center">
                    Solved Problems
                  </h2>
                      ...
                      <div className="relative w-24 h-24">
                        ...
                        >
                          ...
                          {(() => {
                            ...
                            const easyLength =
                              (easyPercent / 100) * circumference;
                            const mediumLength =
                              (mediumPercent / 100) * circumference;
                            const hardLength =
                              (hardPercent / 100) * circumference;
                              ...
                              <>
                                ...
                                {medium > 0 && (
                                  <circle
                                    ...
                                    strokeDashoffset={-(offset + easyLength)}
                                    strokeLinecap="round"
                                  />
                                )}
                                {/* Hard segment */}
                                {hard > 0 && (
                                  <circle
                                    ...
                                    strokeDashoffset={
                                      -(offset + easyLength + mediumLength)
                                    }
                                    strokeLinecap="round"
                                  />
                                )}
                        ...
                        <div className="absolute inset-0 flex flex-col items-center justify-center">
                          ...
                          <span className="text-[9px] text-[#6c6c6c]">
                            Solved
                          </span>
                        </div>
                      </div>
                    ...
                    <div className="flex-1 space-y-2">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                          <div className="w-2.5 h-2.5 rounded-full bg-[#00af9b]"></div>
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2">
                          <div className="w-2.5 h-2.5 rounded-full bg-[#ef4743]"></div>
                          <span className="text-[11px] text-[#6c6c6c]">
                            Hard
                          </span>
                        </div>
                ...
                {/* Stats Card */}
                <div className="bg-white rounded-lg shadow-sm border border-[#e5e5e5] p-2 flex flex-col gap-1.5 flex-1">
                  ...
                  <div className="mt-1 pt-1 border-t border-[#e5e5e5]">
                    <div className="flex gap-1.5 justify-center">
                      <div className="flex flex-col items-center">
                        ...
                        <p className="text-[7px] text-[#6c6c6c] mt-0.5">
                          50 Days
                        </p>
                      </div>
                      <div className="flex flex-col items-center">
              ...
              <div className="flex-1 min-h-0 flex flex-col bg-white rounded-lg shadow-sm border border-[#e5e5e5] p-4 overflow-hidden">
                <div className="flex items-center justify-between mb-3 flex-shrink-0 flex-wrap gap-2">
                  ...
                  <div className="flex items-center gap-4 text-xs text-[#6c6c6c]">
                    <span>
                      Total active days:{" "}
                      <strong className="text-[#1a1a1a]">{activeDays}</strong>
                    </span>
                    <span>
                      Max streak:{" "}
                      <strong className="text-[#1a1a1a]">{maxStreak}</strong>
                    </span>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-between px-1 flex-shrink-0 mt-3">
                <p className="text-xs text-[#6c6c6c] truncate">
                  {stats.isFallback ? (
                    <span className="text-[#ff9800]">Using cached data</span>
                  ) : (
